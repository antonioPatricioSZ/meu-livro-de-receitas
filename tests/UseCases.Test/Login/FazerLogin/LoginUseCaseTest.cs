...
public class LoginUseCaseTest {
    ...
    private static LoginUseCase CriarUseCase(MeuLivroDeReceitas.Domain.Entidades.Usuario usuario) {
        ...
        var repositorioReadOnly = UsuarioReadOnlyRepositorioBuilder.Instancia()
            .Login(usuario).Construir();

        return new LoginUseCase(encriptador, token, repositorioReadOnly);
